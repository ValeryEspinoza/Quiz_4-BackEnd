...
SECRET_KEY = 'django-insecure-t4+s$6(5@hg7rb@4scw0hi$=f+spg15%j8^b*)t1&27-3j4i3z'
...
DATABASES = {
    'default': {
        ...
        'USER': 'valery',  # Tu usuario de MySQL
        'PASSWORD': 'fwd1234',  # La contraseña de tu usuario MySQL
